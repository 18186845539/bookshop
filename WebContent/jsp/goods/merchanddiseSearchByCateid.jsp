...
$(function (){
	$("#go").click(function (){
		...
		//验证 
		location.href="${pageContext.request.contextPath}/member?method=searchMer&nowPage="+jumpPage+"&cateid=${requestScope.cateid}";
	});
});
</script>
</head>
	...
	<div class="con">
		...
		<div class="G_center">
			...
			<table width="720px" height="600px">
				...
				<tr align="center">
					<td colspan="4">
				        <a href="${pageContext.request.contextPath}/member?method=searchMer&nowPage=1&cateid=${requestScope.cateid}">首页</a>  
				        <a href="${pageContext.request.contextPath}/member?method=searchMer&nowPage=${requestScope.castPageModel.upPage}&cateid=${requestScope.cateid}">上一页</a>   
				        <a href="${pageContext.request.contextPath}/member?method=searchMer&nowPage=${requestScope.castPageModel.nextPage}&cateid=${requestScope.cateid}">下一页  </a>   
				        <a href="${pageContext.request.contextPath}/member?method=searchMer&nowPage=${requestScope.castPageModel.totalPage}&cateid=${requestScope.cateid}">末页</a>   
